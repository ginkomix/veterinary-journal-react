						...
						<div className='right'>
							<div className='startForm'>
								<div className='buttonAutoriz' onClick={this.clickButton}>
									<span className={`${this.props.button==='log'? 'activeForm':''} log`} attached='left'>Вход</span>
									<span className={`${this.props.button==='reg'? 'activeForm':''} reg`}  attached='right'>Регистрация</span>
								</div>
								{this.renderForm()}
							</div>
						</div>
